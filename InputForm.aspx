...
<tr>	
	<td width="50%" align="right" valign="middle">APP Id</td>
	<td width="50%" align="center" valign="middle"><input type="text" id="APP_ID" name="APP_ID" value="" /></td>
</tr>
<tr>	
...
<tr>
	...
	<td width="50%" align="center" valign="middle"><input type="text" id="CUST_NAME" name="CUST_NAME" value="ABDUL" /></td>
</tr>
...
<tr>
	...
	<td width="50%" align="center" valign="middle"><input type="text" id="CUST_CITY" name="CUST_CITY" value="Dubai" /></td>
</tr>
<tr>	
	<td width="50%" align="right" valign="middle">State</td>
	<td width="50%" align="center" valign="middle"><input type="text" id="CUST_STATE" name="CUST_STATE" value="Dubai" /></td>
</tr>
<tr>
	<td width="50%" align="right" valign="middle">Country</td>
	<td width="50%" align="center" valign="middle"><input type="text" id="CUST_COUNTRY" name="CUST_COUNTRY" value="UAE" /></td>
</tr>
<tr>
...
<tr>
	...
	<td width="50%" align="center" valign="middle"><input type="text" id="CUST_EMAIL" name="CUST_EMAIL" value="user@gmail.in" /></td>
</tr>
<tr>	
	<td width="50%" align="right" valign="middle">Phone</td>
	<td width="50%" align="center" valign="middle"><input type="text" id="CUST_PHONE" name="CUST_PHONE" value="8888888888" /> </td>
</tr>
<tr><td><h2><u>Customer Shipping Details</u></h2></td></tr>
<tr>
	<td width="50%" align="right" valign="middle">Customer Name</td>
	<td width="50%" align="center" valign="middle"><input type="text" id="CUST_SHIP_NAME" name="CUST_SHIP_NAME" value="ABDUL" /></td>
</tr>
...
<tr>
	<td width="50%" align="right" valign="middle">City</td>
	<td width="50%" align="center" valign="middle"><input type="text" id="CUST_SHIP_CITY" name="CUST_SHIP_CITY" value="Dubai" /></td>
</tr>
<tr>	
	<td width="50%" align="right" valign="middle">State</td>
	<td width="50%" align="center" valign="middle"><input type="text" id="CUST_SHIP_STATE" name="CUST_SHIP_STATE" value="Dubai" /></td>
</tr>
<tr>
	<td width="50%" align="right" valign="middle">Country</td>
	<td width="50%" align="center" valign="middle"><input type="text" id="CUST_SHIP_COUNTRY" name="CUST_SHIP_COUNTRY" value="UAE" /></td>
</tr>
<tr>
	<td width="50%" align="right" valign="middle">Zip Code</td>
...
<tr>
	<td width="50%" align="right" valign="middle">Email</td>
	<td width="50%" align="center" valign="middle"><input type="text" id="CUST_SHIP_EMAIL" name="CUST_SHIP_EMAIL" value="user@gmail.in" /></td>
</tr>
<tr>	
	<td width="50%" align="right" valign="middle">Phone</td>
	<td width="50%" align="center" valign="middle"><input type="text" id="CUST_SHIP_PHONE" name="CUST_SHIP_PHONE" value="8888888888" /> </td>
</tr>
<tr>
